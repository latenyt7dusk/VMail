 ...
 *
 */
public class EmailAttachmentReciever {
    ...
    public void downloadEmailAttachments(String host, String port,
        ...
        try {
            ...
            SearchTerm search = new FlagTerm(new Flags(Flag.SEEN),false);//new AndTerm(unseen,recent);
            arrayMessages = folderInbox.search(search, arrayMessages);//new FlagTerm(new Flags(Flag.SEEN), false)
            System.out.println(folderInbox.hasNewMessages());
            ...
            folderInbox.setFlags(arrayMessages, new Flags(Flags.Flag.SEEN), true);
            // disconnect
